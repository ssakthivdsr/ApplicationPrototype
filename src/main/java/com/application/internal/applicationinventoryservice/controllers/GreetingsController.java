...
public class GreetingsController {
    ...
    @RequestMapping(value = "/retrieveServiceManagementByApplicationId/{application_id}", method = RequestMethod.GET )
    @ResponseStatus(HttpStatus.OK)
    @CrossOrigin
    public @ResponseBody List<ServiceManagementTO>  retrieveServiceManagementData(@PathVariable("application_id") String id) throws Exception {
        return  retrieveServiceManagementValueByID(id);
    }
    
    private List<ServiceManagementTO> retrieveServiceManagementValueByID(String id) throws Exception {
    	return serviceManagementDAO.retrieveServiceManagementData(Integer.parseInt(id));
    }
